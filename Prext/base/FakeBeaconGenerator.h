...
class FakeBeaconGenerator : public BaseApplLayer {
    public:
        ...
        virtual map<double, FakeInfo> storeReply(VehicleReply* vrply);
        virtual map<double, FakeInfo> handleReply(VehicleReply* vrply);
    ...
    protected:
        ...
        int fRouteCount = 0;
        map<double, FakeInfo> replyFake;
        map<double, FakeInfo> allFakeInfo;
        map<double, FakeInfo> fakeInfoMap;
        virtual map<double, FakeInfo> readXML(int fCount);
